...
export default function UserManagement() {
    ...
    const fetchLists = async () => {
        try {
            ...
            // residents
            try {
                const r = await managerService.getUserLists();
                if (r.ok) {
    ...
    const fetchRegistrationCodes = async () => {
        ...
        try {
            const json = await managerService.getRegistrationCodes();
    ...
    const regenerateCode = async (flatNumber, flatNumbers = null) => {
        try {
            ...
            const json = await managerService.regenerateRegistrationCodes(body);
    ...
    const openEdit = async (entity, id) => {
        ...
        try {
            const cfg = configFor(entity);
            const res = await managerService.getUserDetails(cfg.endpoint, id);
    ...
    const saveEntity = async (entity, values, idForUpdate) => {
        ...
        try {
            ...
            const json = await managerService.saveUser(cfg.endpoint, payload);
    ...
    const doDelete = async () => {
        ...
        try {
            ...
            const cfg = configFor(entity);
            const json = await managerService.deleteUser(cfg.endpoint, id);
