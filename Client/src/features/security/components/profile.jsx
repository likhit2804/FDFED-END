...
export const SecurityProfile = () => {
  ...
  useEffect(() => {
    async function loadProfile() {
      try {
        const data = await securityService.getProfile();
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      const data = await securityService.updateProfile(profileData);
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const data = await securityService.changePassword(currentPassword, newPassword);
