...
export const SignIn = () => {
  ...
  const resend = async () => {
    ...
    try { setIsResending(true); await axios.post('http://localhost:3000/resend-otp', { tempToken: pending2fa.tempToken }, { withCredentials: true }); toast.success('OTP resent'); setSecondsLeft(initialTimer); }
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:3000/forgot-password', { email: forgotPasswordEmail, userType: forgotPasswordUserType }, { withCredentials: true });
