...
function SummaryCards({ data, loading }) {
    const summaryData = [
        ...
        { 
            ...
            change: `${data?.issues?.urgent || 0} urgent`, 
            icon: AlertCircle, 
            color: "text-danger", 
            bg: "bg-light" 
        },
        ...
        { 
            ...
            change: `${data?.bookings?.pending || 0} pending`, 
            icon: Calendar, 
            color: "text-warning", 
            bg: "bg-light" 
        },
        { 
            ...
            value: loading ? "-" : `₹${((data?.payments?.amounts?.paid || 0) / 100000).toFixed(1)}L`, 
...
function PaymentsRevenue({ data, loading }) {
    const paymentData = data?.payments?.revenueData || [
            ...
            <main className="pb-5">
                <div className="container-fluid mb-3">
                    <div className="row">
                        ...
                        <div className="col-4">
                            <NotificationsPanel data={dashboardData} loading={loading} />
                        </div>
                    </div>
                </div>
