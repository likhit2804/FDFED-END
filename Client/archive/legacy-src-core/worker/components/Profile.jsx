...
import "../../../assets/css/GlobalStyles/profile.css";
...
export const WorkerProfile = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                setIsLoading(true);
                const data = await workerService.getUserData();
                console.log(data);
                ...
                if (data.success && data.worker) {
                    ...
                    setFormData((prev) => ({
                        ...
                        image: data.worker.image ? `http://localhost:3000/${data.worker.image
                            }` : prev.image
                    }));
                } else {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await workerService.updateProfile(body);
    ...
    const handlePasswordSubmit = async (e) => {
        ...
        try {
            const data = await workerService.changePassword({ cp: passwords.cp, np: passwords.np });
                        ...
                        <form id="passwordForm" type="worker"
                            ...
                            <div className="rule-box">
                                ...
                                <ul className="password-requirements px-2">
                                    <li>
                                        <i className={
                                            `bi ${passwordValidation.minLength ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger'
                                            }`
                                        }></i>
                                    ...
                                    <li>
                                        <i className={
                                            `bi  ${passwordValidation.caseMix ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger'
                                            }`
                                        }></i>
                                    ...
                                    <li>
                                        <i className={
                                            `bi ${passwordValidation.numberSpecial ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger'
                                            }`
                                        }></i>
