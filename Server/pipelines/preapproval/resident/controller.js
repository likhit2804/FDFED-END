...
import {
  ...
  getVisitorById,
  listVisitors,
} from "../../visitor/shared/crud.js";
import { generateCustomID, formatDate } from "../../../core/utils/residentHelpers.js";
...
export const cancelPreApproval = async (req, res) => {
  ...
  try {
    const result = await deleteVisitorById(requestId);
...
export const getPreApprovals = async (req, res) => {
  try {
    ...
    const visitors = await listVisitors({ approvedBy: resident._id });
