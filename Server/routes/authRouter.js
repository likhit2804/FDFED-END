      ...
      const finalToken = jwt.sign(
        {
          ...
          role: verified.userPayload.role || (String(verified.userPayload.userType).toLowerCase() === "admin" ? "admin" : undefined),
    ...
    const finalToken = jwt.sign(
      {
        ...
        role: payload.role || (String(payload.userType).toLowerCase() === "admin" ? "admin" : undefined),
